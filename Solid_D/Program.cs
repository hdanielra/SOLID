...
namespace Solid_D
{
    class Program
    {
        ...
        // Liskov substitution          - sustitución de Liskov...Bárbara Liskov: 1 clase padre que hereda a 1 clase hija, la hija no debe alterar el funcionamiento del padre (no deben sobrar métodos del padre)
        // Interface segregation        - segregación de interfaces: no dar más información de la necesaria...separar tanto como se puedan las interfaces...es mejor tener muchas clases pequeñas y especializadas que una enorme... los clientes no deberían verse forzados a depender de interfaces que no usan.
        // Dependency inversion         - inversión de dependencia: Las clases de alto nivel no deberían depender de las clases de bajo nivel. Ambas deberían depender de las abstracciones. Las abstracciones no deberían depender de los detalles. Los detalles deberían depender de las abstracciones
        ...
        public interface IGeometricArea : IHasArea, IHasPerimeter
        {
